...
\begin{figure}[H]
\center
\includegraphics[scale=0.22]{../figures/task1.png}
...
\subsection{Study the step response for a decoupled system}
Figure \ref{fig:withDecoupSpeed} and X show the system behavior when pulsating the decoupled inputs $u_1$ and $u_2$.

\begin{figure}[H]
\center
\includegraphics[scale=0.22]{../figures/task2.png}
...
\label{fig:withDecoupSpeed}
\end{figure}

\subsection{Study the decoupled system with feedback control}
Here is shown how the system behaves under PID feedback control for both speed and tension.
Figure X show how the system behaves when pulsing the speed reference and having a constant tension reference.
Figure Y show how the system behaves when pulsing the tension reference and having a constant speed reference.
