...
For the air handling system the observability and controllability matrices can be calculated using the Matlab commands \verb|obsv(A,C)| and \verb|ctrb(A,B)|.
The matrices for the air handling system are:

[TODO: matrices for obsv and ctrb]

Using Matlab again \verb|rank| provides the rank of these matrices.
