...
From (8), (10), and (11) above, the system transfer function is found to be:
...
Following the method described in section 2.2 the state space representation is found to be:
...
From section 2.3 the singular values are shown in figure \ref{fig:systemsingular}:


\begin{figure}[h!]
\center
\includegraphics[scale=0.7]{../code/figures/systemSingular.png}
\caption{The singular values of the system.}
...
The system is controllable as the controllability matrix has full rank as seen below:
...
The system is observable as the observability matrix has full rank as shown:
