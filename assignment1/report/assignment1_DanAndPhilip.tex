...
However, if one so desires, the concluded state space representation could be translated to one where the states have the same physical meaning as the measured output temperature and humidity. 
