...
\begin{equation}
G_{11}(s) = \frac{K_{11}}{\tau_{1} s + 1} = \frac{15}{50s + 1}
\end{equation}
\begin{equation}
G_{12}(s) = \frac{K_{12}}{\tau_{2} s + 1} = \frac{-11}{10s + 1}
\end{equation}
\begin{equation}
G_{21}(s) = \frac{K_{21}}{\tau_{1} s + 1} = \frac{-25}{50s + 1}
\end{equation}
\begin{equation}
G_{22}(s) = \frac{K_{22}}{\tau_{2} s + 1} = \frac{70}{10s + 1}
\end{equation}

\subsection{Question 2}
Following the method described in section 2.2 we find the state space representation to be:
