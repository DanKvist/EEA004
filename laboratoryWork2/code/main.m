...
%Simulate the step response of the nonliner system
...
%Simulate the sine wave response of the nonliner system
load_system('systemAnalysis')
...
%Populate the linearized equations
A = [   0                       1   0                   0;
        0                       0   m*g/(J_R/R^2 + m)   0;
        0                       0   0                   1;
...
%Time axis adn inital condition
t = 0:0.01:1;
...
%% Simulate the zero input solution
...
%Plot the difference between calculation and simulation
zeroIn = figure(3);
plot(t, y_cal' - y_sim)
...
%Pole placement metric caluclation
...
%Plot the composed uncertain result
figUncert = figure(8);
plot(t, [ppY(:,1) lqrY(:,1)])
hold on
